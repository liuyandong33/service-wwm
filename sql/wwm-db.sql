...
(
    ...
    flow DECIMAL(11, 3) NOT NULL COMMENT '流量（m³/h）',
    power DECIMAL(11, 3) NOT NULL COMMENT '配用功率（KW）',
    lift DECIMAL(11, 3) NOT NULL COMMENT '扬程（M）',
    rotary_speed DECIMAL(11, 3) NOT NULL COMMENT '同步转速（r/min）',
    caliber DECIMAL(11, 3) NOT NULL COMMENT '排出口径（mm）',
    weight DECIMAL(11, 3) NOT NULL COMMENT '重量（KG）',
    rated_voltage DECIMAL(11, 3) NOT NULL COMMENT '额定电压（V）',
    rated_current DECIMAL(11, 3) NOT NULL COMMENT '额定电流（V）',
    frequency DECIMAL(11, 3) NOT NULL COMMENT '频率（HZ）',
    international_protection_marking VARCHAR(20) NOT NULL COMMENT '外壳防护等级',
    insulation_level VARCHAR(20) NOT NULL COMMENT '绝缘等级',
    phase VARCHAR(20) NOT NULL COMMENT '相数',
    product_standard_no VARCHAR(50) NOT NULL COMMENT '产品标准编号',
    production_license_no VARCHAR(50) NOT NULL COMMENT '生产许可证编号',
...
DROP TABLE IF EXISTS attached_device;
CREATE TABLE attached_device
(
    id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'ID',
    water_works_id BIGINT NOT NULL COMMENT '水厂ID',
    device_id BIGINT NOT NULL COMMENT '设备ID',
    ...
    detailed_parameter VARCHAR(255) NOT NULL COMMENT '详细参数',
    created_time DATETIME NOT NULL DEFAULT NOW() COMMENT '创建时间',
    created_user_id BIGINT NOT NULL COMMENT '创建人id',
    updated_time DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW() COMMENT '最后更新时间',
    updated_user_id BIGINT NOT NULL COMMENT '最后更新人id',
...
DROP TABLE IF EXISTS wear_part;
CREATE TABLE wear_part
(
    id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'ID',
    water_works_id BIGINT NOT NULL COMMENT '水厂ID',
    device_id BIGINT NOT NULL COMMENT '设备ID',
    device_code VARCHAR(20) NOT NULL COMMENT '设备编号',
    name VARCHAR(20) NOT NULL COMMENT '配件名称',
...
(
    id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT 'ID',
    water_works_id BIGINT NOT NULL COMMENT '水厂ID',
    code VARCHAR(20) NOT NULL COMMENT '采购申请单编号',
    name VARCHAR(20) NOT NULL COMMENT '名称',
    supplier_id BIGINT NOT NULL COMMENT '供应商ID',
    application_time DATETIME NOT NULL COMMENT '申请时间',
    applicant_id BIGINT NOT NULL COMMENT '申请人ID',
    total_amount DECIMAL(11, 3) NOT NULL COMMENT '金额',
    actual_amount DECIMAL(11, 3) NOT NULL COMMENT '实际金额',
