package build.dream.wwm.models.web;
...
public class DoDeleteWithRequestParametersModel {
    ...
    public static class Builder {
        private final DoDeleteWithRequestParametersModel instance = new DoDeleteWithRequestParametersModel();
